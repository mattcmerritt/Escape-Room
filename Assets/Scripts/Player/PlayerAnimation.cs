...
public class PlayerAnimation : NetworkBehaviour
{
    ...
    private NetworkVariable<bool> PlayerIsMoving = new NetworkVariable<bool>(false, NetworkVariableReadPermission.Everyone, NetworkVariableWritePermission.Owner);
